...
/**
 * Esta clase se encarga de guardar todas las tareas y subtareas de cada
 * proyecto creado. Cada proyecto se compone de un nombre de proyecto y de
 * diferentes listas de tareas (una por cada estado).
 *
...
public class Proyecto implements Serializable {
    ...
    /**
     * Constructor principal Crea un objeto Proyecto con todos sus estados
     * vacíos.
     *
     * @param nombre
     */
